...
do
            # if [[ $BORDER != 6 || $RHO_TEST != 9 ]]; then
                for SEED in 1000 2000 3000 4000 5000 6000 7000 8000 9000 500
                    ...
                    PREFIX="GENNURD_${DATASET}_BS${BS}_seed${SEED}_FINAL"
...
eval '$PYTHON_STRING nurd_generated_representation_for_synthetic.py $ARGS_STRING --add_pred_suffix=_allLR01_wd0_LAM1_FRAC2_NORR_LONG --lambda_=1 --max_lambda_=1 --frac_phi_steps=2 --randomrestart=-1 > SBATCH_LOGS/${PREFIX}_allLR01_wd0_LAM1_FRAC2_NORR_LONG.log'
