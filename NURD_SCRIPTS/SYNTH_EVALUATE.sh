...
eval '$PYTHON_STRING evaluate_model.py $ARGS_STRING --add_pred_suffix=_allLR01_wd0_LAM1_FRAC2_NORR_LONG --add_final_results_suffix=SAVED  --lambda_=1 --max_lambda_=1 --frac_phi_steps=2 --randomrestart=-1 --load_weights --load_final_model > SBATCH_LOGS/${PREFIX}_allLR01_wd0_LAM1_FRAC2_NORR_LONG_SAVED.log'
                    """
                    printf "\n"
